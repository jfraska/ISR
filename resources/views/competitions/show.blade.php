        ...
        <div class="z-20 -mt-20 flex w-5/6 flex-col bg-white px-5">
            ...
            >
                <div class="flex w-3/4 flex-col">
                    <div
                        class="mt-2 flex w-full flex-row justify-between border-b border-t border-gray-200 py-2"
                    >
                        <div class="flex">
                            <p class="text-sm font-normal">
                    ...
                    <div class="h-full w-[200px] bg-blue-800"></div>
                    <div
                ...
                <div class="flex h-[500px] w-[200px] bg-black"></div>
            </div>
        </div>
