...
@section('content')
    <div class="px-9 py-28 md:px-20">
        <div class="flex w-full flex-col-reverse items-start justify-start gap-10 md:flex-row">
                        ...
                        $content = preg_replace_callback(
                            ...
                            function ($matches) {
                                return '<ul class="text-md font-regular text-justify mb-5">' .
                                    preg_replace(
                                        '/<li>/',
                                        '<li class="list-disc text-md font-regular text-justify ml-5 mb-2">',
                                        $matches[1],
                                    ) .
                                    '</ul>';
                            },
            ...
            <div class="flex h-full w-full flex-col md:w-1/2">
                <img class="h-[480px] w-[700px] border border-black" src="{{ $department->getFirstMediaUrl() }}"
                    alt="department" />
                <div class="mt-5 bg-white px-0 py-1">
                    <h4 class="py-3 text-justify text-base font-bold md:text-lg">
                    ...
                    <div class="flex flex-col pb-2">
                        <div class="flex flex-row text-justify">
                            <h5 class="w-[230px] text-sm font-bold md:text-base">
                                Kepala Departemen
                            </h5>
                ...
                <div class="bg-white">
                    ...
                    <div class="flex flex-row justify-between pl-0 pr-1">
                        ...
                        <button id="toggle-button" data-collapse-toggle="dropdown-staff" type="button">
                            <img src="/images/arrow-dropdown.svg" alt="dropdown" class="mt-1 h-[15px] w-[15px]" />
                        </button>
                    </div>
