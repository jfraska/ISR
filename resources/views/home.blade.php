            ...
            <div class="relative h-[700px] w-full px-14 pt-12">
                ...
                <div class="relative ml-40 mt-24">
                    <h1 class="relative text-2xl font-bold">
                        PENGUMUMAN
                        <span
                            class="ml-5 after:absolute after:bottom-2 after:h-[3px] after:w-[78%] after:bg-[#0D5568]"></span>
                    </h1>
                </div>
                <div class="ml-40 flex w-5/6 flex-col gap-2">
                    <div class="flex h-[130px] w-full justify-between gap-[100px] pt-3">
                        <div class="w-full border-b-2 border-[#0D5568] p-1">
                            <div class="relative flex flex-row items-start p-3">
                                <div class="mr-[50px] flex-grow">
                                    <h1 class="text-[16px] font-bold" style="color: gray">
                                        09 / 12 / 2021
                                    </h1>
                    ...
                    <div class="flex h-[130px] w-full justify-between gap-[100px]">
                        <div class="w-full border-b-2 border-[#0D5568] p-1">
                            <div class="relative flex flex-row items-start p-3">
                                <div class="mr-[50px] flex-grow">
                                    <h1 class="text-[16px] font-bold" style="color: gray">
                ...
                <div
                    ...
                    <img src="/images/panah.svg" alt="arrow" class="h-[15px] w-[15px]" />
                </div>
                <div class="absolute bottom-0 right-0">
                    <img src="/images/side-decor-bottom-right.png" alt="" />
                </div>
