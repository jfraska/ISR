...
@section('content')
            ...
            <div class="mr-8" style="width: 500px; height: 200px flex-grow: 1; margin-right: 50px">
                <div class="relative">
                    <h1
                        ...
                        ">
                        Profil ISR
                        <span class="ml-5 after:absolute after:bottom-3 after:h-[3px] after:w-2/3 after:bg-blue-500"></span>
                    </h1>
                </div>
                <p style="margin-top: 10px; font-size: 15px">
                    Interdisciplinary Scientific Research(ISR) merupakan suatu
                    kelompok studi di bidang penalaran dan penelitian di lingkup
                    kampus Universitas Pembangunan Nasional “ Veteran”
                    Yogyakarta. Organisasi ini lahir sebagai wujud kontribusi
                    mahasiswa dalam menjujung tinggi Tri Dharma Perguruan Tinggi
                    yaitu pendidikan dan pengajaran, penelitian, dan pengabdian
                    kepada masyarakat serta mendukung visi dan misi UPN “
                    Veteran” Yogyakarta dalam menyelenggarakan penelitian dan
                    pengabdian kepada masyarakat.
                </p>
                <div class="mt-7 items-center border border-white p-3"
                    style="
                        width: 190px;
                        height: 35px;
    ...
    {{-- Start Pendaftaran --}}
    <section>
        <div class="mx-auto flex w-4/5 flex-col gap-2 px-20 py-10">
            <div class="flex h-[250px] w-full justify-between gap-2">
                <div class="w-full border border-blue-600 p-1">
                    <div class="p-3"
                        style="
                            position: relative;
                            display: flex;
                        ...
                        <div class="mr-8" style="flex-grow: 1; margin-right: 50px">
                            ...
                            <div class="mt-3 items-center border border-white p-3"
                                style="
                                    width: 190px;
                                    height: 35px;
                                    background-color: #028caa;
                    ...
                    <div class="p-3"
                        ...
                        <div class="mr-8" style="flex-grow: 1; margin-right: 50px">
                            ...
                            <p style="margin-bottom: 0; font-size: 15px">
                                ...
                                bangsa, tapi bingung mulai dari mana? Atau ingin
                                mengisi waktumu dengan hal-hal yang bermanfaat?
                                Yap disini tempatnya!
                            </p>
                            <div class="mt-3 items-center border border-white p-3"
                                style="
                                    width: 190px;
            ...
            <div class="mr-8" style="width: 500px; height: 200px flex-grow: 1; margin-left: 50px">
                <div class="relative">
                    <h1
                        ...
                        Visi ISR
                        <span
                            class="ml-5 after:absolute after:bottom-3 after:h-[3px] after:w-2/3 after:bg-blue-500"></span>
                    </h1>
                </div>
                <p style="margin-top: 10px; font-size: 15px">
                    Menjadi lembaga penalaran dan penelitian interdisipliner
                    yang mampu mewadahi anggota dalam menghasilkan karya karya
                    yang kreatif, inovatif serta dan menumbuhkan integritas dan
                    semangat kecendekiaan dalam pengabdian kepada masyarakat.
                </p>
                <div class="mt-7 items-center border border-white p-3"
                    style="
                        width: 190px;
        ...
        <div class="p-8"
            ...
            <div class="mr-8" style="width: 500px; height: 200px flex-grow: 1; margin-right: 50px">
                ...
                <ol style="margin-top: 10px; font-size: 15px">
                    <li>
                        1. Melakukan kegiatan pengkajian dan peneletian dengan
                        landasan ilmiah secara interdisipliner.
                    </li>
                    <li>
    ...
    <section>
        <div class="p-10">
            <p class="border-b-4 border-b-blue-600" style="font-size: 24px; font-weight: bold">
                Berita Terkini
            </p>
            <div class="">
                <div class="flex flex-wrap pt-2">
                    <div class="w-full p-1 md:w-1/2" style="style=width: 550px; height: 200px">
                        <div class="p-3"
                            style="
                                position: relative;
                                display: flex;
                            ...
                            <div class="mr-8" style="flex-grow: 1; margin-right: 50px">
                                ...
                                <p style="margin-bottom: 0; font-size: 16px">
                                    Selamat kepada Tim Giriwiradaya
                                    <br />
                                    Program Wira Desa 2021 UKM ISR UPNVY telah
                                    berhasil mendapatkan Medali Silver 2nd dalam
                                    "ABDIDAYA 2021".
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="p-3"
                                ...
                                <div class="mr-8" style="flex-grow: 1; margin-right: 50px">
                                    ...
                                    <p
                                        ...
                                        Selamat kepada Tim Giriwiradaya
                                        <br />
                                        Program Wira Desa 2021 UKM ISR UPNVY
                                        telah berhasil mendapatkan Medali Silver
                                        2nd dalam "ABDIDAYA 2021".
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <section>
        <div class="ml-40 p-10">
            ...
            <div class="">
                <div class="flex flex-wrap pt-2">
                    <div class="w-full border-b-2 border-gray-700 p-1 md:w-1/2" style="style=width: 550px; height: 120px">
                        <div class="p-3"
                            style="
                                position: relative;
                                display: flex;
            ...
            <div class="mt-7 items-center border border-white p-3"
                style="
                    ...
                    flex-direction: row;
                ">
                <a href="" style="color: #028caa; font-weight: bold">
