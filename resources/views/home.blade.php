    ...
    <div class="">
        ...
        <section class="relative bg-white py-10">
            ...
            <div class="mx-auto flex w-full flex-row gap-5 overflow-x-auto md:w-4/5 md:flex-col">
                <div class="z-10 flex h-[300px] gap-5 md:h-[180px]">
                    <div class="flex w-full items-start gap-2 border-2 border-[#0D5568] bg-white p-4">
        ...
        <section class="bg-white">
            <div class="flex justify-center">
                <h1 class="text-3xl font-bold" style="margin-top: 25px;">Agenda Kegiatan</h1>
            </div>
            <div class="container mx-auto px-4 py-2 md:py-8">
                <div class="flex justify-center">
                    <hr style="border-color: #0D5568; border-width: 3px; width: 100%;">
                </div>
            </div>
            <div class="bg-white p-1 my-auto mx-auto max-w-screen-lg">
                ...
                <div class="antialiased sans-serif bg-white h-screen">
                    <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
                        <div class="container mx-auto px-4 py-2 md:py-12">
                            ...
                            <div class="bg-gray-400 rounded-sm shadow overflow-hidden">
                                ...
                                <div class="flex items-center justify-between py-2 px-12">
                                    ...
                                    <div class="border rounded-lg px-1" style="padding-top: 2px;">
                                        <button type="button"
                                            ...
                                            <svg class="h-6 w-6 text-black inline-flex leading-none" fill="none"
                                    ...
                                    <div class="flex flex-wrap" style="margin-bottom: -40px;">
                                        <template x-for="(day, index) in DAYS" :key="index">
                                            <div style="width: 14.26%" class="px-2 py-2">
                                                <div x-text="day"
                                                    class="text-black text-sm uppercase tracking-wide font-bold text-center">
                                                </div>
                                            </div>
                                        </template>
                                    </div>
            ...
            <div class="container mx-auto px-4 py-2 md:py-20 max-w-screen-lg">
                <div class="w-auto mx-auto">
                    @foreach ($agenda as $item)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden flex mb-8">
                            <div class="w-1/3">
