                ...
                <div class="p-5">
                    ...
                    <div class="flex flex-row justify-between">
                        ...
                        <a href="{{ route('merchandise.show', $merchandise->slug) }}"
                            class="inline-flex items-center justify-center w-[35%] px-3 py-2 text-sm font-medium text-center text-white bg-[#0D5568] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Beli
                        </a>
                    </div>
                </div>
