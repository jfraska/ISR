<div>
    ...
    @else
        <article
            class="mb-1 rounded-lg bg-white p-6 text-base dark:bg-gray-900"
        >
    ...
    @if ($hasReplies)
        <article
            class="mb-1 ml-1 border-t border-gray-200 p-1 lg:ml-12 dark:border-gray-700 dark:bg-gray-900"
        >
