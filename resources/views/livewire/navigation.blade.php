<nav
    class="fixed inset-x-0 left-0 right-0 top-0 z-50 bg-transparent bg-gradient-to-b from-gray-700 to-transparent transition-all duration-200 ease-in-out"
    id="navbar"
>
    <div
    ...
    >
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex flex-row items-center p-1 md:p-0">
                ...
                >
                    <img
                        src="/images/upn-blu-navbar-logo.png"
                        class="h-12"
                        alt="UPN BLU Logo"
                    />
                </a>
                <a
                    href="#"
                    class="ml-2 flex items-center space-x-3 rtl:space-x-reverse"
                >
                    <img
                        src="/images/isr-navbar-logo.png"
                        class="h-12"
                        alt="ISR Logo"
                    />
                </a>
                ...
                >
                    <img
                        src="/images/isr-navbar-logo2.png"
                        class="h-12"
                        alt="ISR Logo2"
                    />
                </a>
    ...
    <div id="navbar-hamburger" class="hidden">
        ...
        <a href="#" class="relative block px-4 py-2">
            Menu 1
            <div class="left-0 top-full hidden rounded-lg bg-white shadow-lg">
                <!-- Submenu -->
        ...
        <a href="#" class="relative block px-4 py-2 font-bold">Departemen</a>
        <div class="left-0 top-full hidden rounded-lg bg-white shadow-lg">
            <!-- Submenu -->
