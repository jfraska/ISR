<form class="mb-6" wire:submit="{{ $method }}">
    ...
    <div
        ...
        <textarea id="{{ $inputId }}" rows="6"
            class="@error($state . '.body')  border-red-500 @enderror w-full border-0 px-0 text-sm text-gray-900 focus:outline-none focus:ring-0 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
            placeholder="Write a comment..." wire:model.live="{{ $state }}.body">
        </textarea>
