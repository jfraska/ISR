                    ...
                    <div class="rounded-lg shadow w-[400px] h-96 bg-[#0D5568]">
                        <a href="#">
                            <div class="flex flex-col h-80 relative rounded-lg"
                                style="background-image: url('/images/carousel/football2.jpg'); background-size: cover; background-position: center;">
                                <p class="absolute left-2 bottom-2 text-base font-semibold text-white text-wrap">UKM ISR UPN
                                    VETERAN YOGYAKARTA LOLOS ABDIDAYA 2021</p>
                            </div>
                            <div class="p-5 flex items-center justify-center">
                                <h5 class="mb-2 text-base tracking-tight text-white text-center">15 September 2021</h5>
                            </div>
                        </a>
                    </div>
                    <div class="rounded-lg shadow w-[400px] h-96 bg-[#0D5568]">
