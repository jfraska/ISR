...
@section('content')
    <article class="col-span-4 flex h-full w-full flex-col items-center md:col-span-3">
        ...
        <div class="z-20 -mt-20 w-5/6 rounded bg-white p-8">
            ...
            <div class="flex w-full flex-col items-start justify-between gap-8 lg:flex-row-reverse">
                <div class="hidden w-1/4 flex-col items-start justify-start rounded-md border border-gray-200 p-4 lg:flex">
                ...
                <div class="w-full lg:w-3/4">
                    ...
                    <div class="my-10 flex w-full flex-col items-start justify-start gap-5 rounded-md">
                        <h1 class="w-fit border-b-2 border-b-[#F5D05E] py-2 text-xl font-bold">
                            {{ $post->categories->name }}
                            Terkait
                        </h1>
                        @foreach ($relates as $item)
                            <a class="w-full border-b border-gray-200"
